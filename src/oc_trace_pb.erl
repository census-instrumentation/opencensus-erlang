...
-export_type(['u_int_64_value_pb'/0, 'truncatable_string_pb'/0, 'module_pb'/0, 'stack_frame_pb'/0, 'double_value_pb'/0, 'timestamp_pb'/0, 'attribute_value_pb'/0, 'stack_frames_pb'/0, 'int_64_value_pb'/0, 'attributes_pb'/0, 'link_pb'/0, 'message_event_pb'/0, 'annotation_pb'/0, 'time_event_pb'/0, 'time_events_pb'/0, 'links_pb'/0, 'u_int_32_value_pb'/0, 'bool_value_pb'/0, 'status_pb'/0, 'stack_trace_pb'/0, 'span_pb'/0, 'float_value_pb'/0, 'int_32_value_pb'/0, 'bytes_value_pb'/0, 'string_value_pb'/0]).

-spec encode_msg(#u_int_64_value_pb{} | #truncatable_string_pb{} | #module_pb{} | #stack_frame_pb{} | #double_value_pb{} | #timestamp_pb{} | #attribute_value_pb{} | #stack_frames_pb{} | #int_64_value_pb{} | #attributes_pb{} | #link_pb{} | #message_event_pb{} | #annotation_pb{} | #time_event_pb{} | #time_events_pb{} | #links_pb{} | #u_int_32_value_pb{} | #bool_value_pb{} | #status_pb{} | #stack_trace_pb{} | #span_pb{} | #float_value_pb{} | #int_32_value_pb{} | #bytes_value_pb{} | #string_value_pb{}) -> binary().
...
decode_msg(Bin, MsgName, Opts) when is_binary(Bin) ->
    ...
    case MsgName of
	  ...
	  try d_msg_stack_frame_pb(Bin, TrUserData) catch
		...
		error({gpb_error,
		       {decoding_failure,
			{Bin, stack_frame_pb, {Class, Reason, StackTrace}}}})
	  end;
      double_value_pb ->
	  ...
	  try d_msg_timestamp_pb(Bin, TrUserData) catch
		...
		error({gpb_error,
		       {decoding_failure,
			{Bin, timestamp_pb, {Class, Reason, StackTrace}}}})
	  end;
      attribute_value_pb ->
	  try d_msg_attribute_value_pb(Bin, TrUserData) catch
		...
		error({gpb_error,
		       {decoding_failure,
			{Bin, attribute_value_pb,
			 {Class, Reason, StackTrace}}}})
	  end;
      stack_frames_pb ->
	  try d_msg_stack_frames_pb(Bin, TrUserData) catch
	    Class:Reason ->
		StackTrace = erlang:get_stacktrace(),
		error({gpb_error,
		       {decoding_failure,
      ...
      int_64_value_pb ->
	  try d_msg_int_64_value_pb(Bin, TrUserData) catch
	    Class:Reason ->
		StackTrace = erlang:get_stacktrace(),
		error({gpb_error,
		       {decoding_failure,
      ...
      attributes_pb ->
	  try d_msg_attributes_pb(Bin, TrUserData) catch
	    Class:Reason ->
		StackTrace = erlang:get_stacktrace(),
		error({gpb_error,
		       {decoding_failure,
			{Bin, attributes_pb, {Class, Reason, StackTrace}}}})
	  end;
      link_pb ->
      ...
      annotation_pb ->
	  try d_msg_annotation_pb(Bin, TrUserData) catch
	    Class:Reason ->
		StackTrace = erlang:get_stacktrace(),
		error({gpb_error,
		       {decoding_failure,
      ...
      time_event_pb ->
	  try d_msg_time_event_pb(Bin, TrUserData) catch
	    Class:Reason ->
		StackTrace = erlang:get_stacktrace(),
		error({gpb_error,
		       {decoding_failure,
      ...
      u_int_32_value_pb ->
	  try d_msg_u_int_32_value_pb(Bin, TrUserData) catch
	    Class:Reason ->
		StackTrace = erlang:get_stacktrace(),
		error({gpb_error,
		       {decoding_failure,
	  ...
	  try d_msg_status_pb(Bin, TrUserData) catch
		...
		error({gpb_error,
		       {decoding_failure,
			{Bin, status_pb, {Class, Reason, StackTrace}}}})
	  end;
      stack_trace_pb ->
	  ...
	  try d_msg_span_pb(Bin, TrUserData) catch
		...
		error({gpb_error,
		       {decoding_failure,
			{Bin, span_pb, {Class, Reason, StackTrace}}}})
	  end;
      float_value_pb ->
	  ...
	  try d_msg_bytes_value_pb(Bin, TrUserData) catch
		...
		error({gpb_error,
		       {decoding_failure,
			{Bin, bytes_value_pb, {Class, Reason, StackTrace}}}})
	  end;
      string_value_pb ->
	  try d_msg_string_value_pb(Bin, TrUserData) catch
	    Class:Reason ->
		StackTrace = erlang:get_stacktrace(),
		error({gpb_error,
		       {decoding_failure,
			{Bin, string_value_pb, {Class, Reason, StackTrace}}}})
	  end
    end.
...
get_msg_names() ->
    [u_int_64_value_pb, truncatable_string_pb, module_pb,
     stack_frame_pb, double_value_pb, timestamp_pb,
     attribute_value_pb, stack_frames_pb, int_64_value_pb,
     attributes_pb, link_pb, message_event_pb, annotation_pb,
     time_event_pb, time_events_pb, links_pb,
     u_int_32_value_pb, bool_value_pb, status_pb,
     stack_trace_pb, span_pb, float_value_pb,
     int_32_value_pb, bytes_value_pb, string_value_pb].
