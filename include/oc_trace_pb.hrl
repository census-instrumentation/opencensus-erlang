...
-define(oc_trace_pb_gpb_version, "4.4.1").

-ifndef('TRACESTATE_PB_PB_H').
-define('TRACESTATE_PB_PB_H', true).
-record(tracestate_pb,
        {entries = []           :: [oc_trace_pb:entry_pb()] | undefined % = 1
        }).
-endif.

-ifndef('ENTRY_PB_PB_H').
-define('ENTRY_PB_PB_H', true).
-record(entry_pb,
...
-record(message_event_pb,
        {type = 'TYPE_UNSPECIFIED' :: 'TYPE_UNSPECIFIED' | 'SENT' | 'RECEIVED' | integer() | undefined, % = 1, enum opencensus.proto.trace.v1.Span.TimeEvent.MessageEvent.Type
...
-record(link_pb,
        {trace_id = <<>>        :: iodata() | undefined, % = 1
         ...
         type = 'TYPE_UNSPECIFIED' :: 'TYPE_UNSPECIFIED' | 'CHILD_LINKED_SPAN' | 'PARENT_LINKED_SPAN' | integer() | undefined, % = 3, enum opencensus.proto.trace.v1.Span.Link.Type
...
-record(span_pb,
        {trace_id = <<>>        :: iodata() | undefined, % = 1
         span_id = <<>>         :: iodata() | undefined, % = 2
         tracestate = undefined :: oc_trace_pb:tracestate_pb() | undefined, % = 15
         parent_span_id = <<>>  :: iodata() | undefined, % = 3
         name = undefined       :: oc_trace_pb:truncatable_string_pb() | undefined, % = 4
         kind = 'SPAN_KIND_UNSPECIFIED' :: 'SPAN_KIND_UNSPECIFIED' | 'SERVER' | 'CLIENT' | integer() | undefined, % = 14, enum opencensus.proto.trace.v1.Span.SpanKind
...
-record(attribute_value_pb,
        {value                  :: {string_value, oc_trace_pb:truncatable_string_pb()} | {int_value, integer()} | {bool_value, boolean() | 0 | 1} | {double_value, float() | integer() | infinity | '-infinity' | nan} | undefined % oneof
        }).
-endif.
